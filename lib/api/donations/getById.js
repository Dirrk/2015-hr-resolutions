...
module.exports = function getById(request, reply) {
    ...
    this.els.get({index: config.elsDonationsIndex, type: config.elsDonationsType, id: id}, function(error, resp) {
        ...
        response.items_needed = doc.items_needed;
